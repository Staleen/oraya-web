...
function lite(b: Booking): string {
  return JSON.stringify({
    ...
    payment_link_status: b.payment_link_status ?? null,
    payment_link_provider: b.payment_link_provider ?? null,
    payment_link_expires_at: b.payment_link_expires_at ?? null,
    villa: b.villa,
    check_in: b.check_in,
