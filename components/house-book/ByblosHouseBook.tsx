...
/**
 * Villa Byblos — The House Book (9 A4 pages).
 *
 * Converted one-to-one from the approved Claude Design print source
 * preserved by PR #73 (docs/design/phase-16c/welcome-guide/
 * claude-design-drafts/Villa-Byblos-Guest-Documents-Source-final/).
 * STATIC document — no guest name, no stay dates, no booking reference,
 * no access codes.
 *
 * One deliberate web deviation, flagged for David: the printed design's
 * bracketed restaurant sample rows are replaced with placeholder-free
 * Living List copy until real venue names exist. The real practical rows
 * (mini-market, bakery, pharmacy, ATM & fuel) are kept as approved.
 */

const VILLA = "Villa Byblos";
const A = "/house-book/shared";
const AB = "/house-book/byblos";
const EXPLORE_URL = "https://stayoraya.com/explore/byblos";
const MAPS_URL = "https://www.google.com/maps/search/?api=1&query=34.106387,35.661531";

export default function ByblosHouseBook() {
  return (
    <>
      {/* 1 · Cover */}
      <HbPage
      ...
      >
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
          ...
          <h1 className="oraya-display oraya-display--italic" style={{ fontSize: "54pt", lineHeight: 1.05, color: "var(--oraya-gold-deep)", margin: "0 0 8mm" }}>Byblos</h1>
          <p className="eyebrow-t" style={{ margin: "0 0 3mm" }}>the house book</p>
          <p className="oraya-eyebrow" style={{ margin: 0 }}>Mastita · Jbeil · Lebanon</p>
        </div>
        <div>
          <span className="oraya-gem" style={{ marginBottom: "4mm" }} />
          <p className="micro" style={{ margin: "3mm 0 0" }}>A guide to your stay at Villa Byblos</p>
        </div>
      </HbPage>
      ...
      <HbPage label="House Book — Essentials" tone="ivory" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", columnGap: "4mm", marginBottom: "7mm" }}>
          ...
          <div className="arch-cell">
            ...
            <div className="tx">Outdoor sound carries.</div>
          </div>
          <div className="arch-cell">
            <div className="micro" style={{ color: "var(--oraya-terracotta)" }}>Pool cover</div>
            <div className="nm" style={{ fontSize: "11pt" }}>Off · then on</div>
            <div className="tx">Off before swimming — back on after every use</div>
          </div>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: "5mm", marginBottom: "8mm" }}>
          <a href={MAPS_URL} className="warm-panel" style={{ display: "grid", gridTemplateColumns: "auto 1fr", columnGap: "6mm", alignItems: "center" }}>
            <img src={`${AB}/oraya-qr-maps-byblos.svg`} alt="QR code — Villa Byblos in Google Maps" style={{ width: "19mm", height: "19mm", display: "block" }} />
            <div className="fact">
              <div className="l">The villa’s location</div>
              <div className="s" style={{ marginTop: 0 }}>Scan to open Villa Byblos in Google Maps — handy for taxis, deliveries, and finding your way home.</div>
            </div>
          </a>
        ...
        <div style={{ borderTop: "0.5pt solid var(--oraya-gold-28)", borderBottom: "0.5pt solid var(--oraya-gold-28)", padding: "8mm 0 6mm", marginBottom: "6mm" }}>
          <img src={`${AB}/oraya-coast-plate-jbeil-mastita.svg`} alt="" style={{ width: "118mm", display: "block", margin: "0 auto" }} />
          <p className="micro" style={{ textAlign: "center", margin: "4mm 0 0" }}>Mastita · Jbeil — between the mountains and the sea</p>
        </div>
      ...
      <HbPage label="House Book — Welcome letter" tone="beige-light" style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div className="arch-panel" style={{ width: "138mm", padding: "16mm 14mm 12mm", textAlign: "center" }}>
          ...
          <div className="body" style={{ fontSize: "10pt", lineHeight: 1.8, textAlign: "left" }}>
            <p style={{ margin: "0 0 4mm" }}>It is our pleasure to welcome you to Villa Byblos. We hope your time here is restful, private, and entirely effortless.</p>
            <p style={{ margin: "0 0 4mm" }}>This little book holds everything you need for your stay — how the villa and its comforts work, what surrounds you in Byblos and beyond, the few things we kindly ask of our guests, and how to reach us at any hour.</p>
      ...
      {/* 4 · Around Villa Byblos */}
      <HbPage label="House Book — Around Villa Byblos" tone="ivory" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div>
            <p className="eyebrow-t" style={{ margin: "0 0 3mm" }}>Around Villa Byblos</p>
            <h2 className="catch">Explore<b>.</b></h2>
          </div>
          <div style={{ width: "62mm" }}>
            <img src={`${AB}/oraya-coast-plate-jbeil-mastita.svg`} alt="" style={{ width: "62mm", display: "block" }} />
          </div>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", columnGap: "4mm", marginBottom: "6mm" }}>
          <div className="arch-cell" style={{ paddingTop: "7mm" }}>
            <div className="micro" style={{ color: "var(--oraya-terracotta)" }}>~10 min</div>
            <div className="nm">Byblos Castle</div>
            <div className="tx">The Crusader castle above one of the world’s oldest harbours. Go late afternoon, for the light.</div>
          </div>
          <div className="arch-cell" style={{ paddingTop: "7mm" }}>
            <div className="micro" style={{ color: "var(--oraya-terracotta)" }}>~10 min</div>
            <div className="nm">The Old Souk</div>
            <div className="tx">Stone lanes, small ateliers, evening cafés — unhurried, exactly as it should be.</div>
          </div>
          <div className="arch-cell" style={{ paddingTop: "7mm" }}>
            <div className="micro" style={{ color: "var(--oraya-terracotta)" }}>~12 min</div>
            <div className="nm">Harbour & beaches</div>
            <div className="tx">The fishing port, the seafront walk, and swims — sandy or rocky — either side of town.</div>
          </div>
        </div>
        {/* Web deviation: the printed design carries bracketed sample rows
            in the left column. Public web copy is
            placeholder-free until real venue names are approved. */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: "9mm", marginBottom: "6mm" }}>
          <div>
            <p className="micro" style={{ color: "var(--oraya-terracotta)", margin: "0 0 2mm" }}>Tables we recommend — the living list</p>
            <p className="body" style={{ fontSize: "8.5pt", lineHeight: 1.65, margin: 0, padding: "2.8mm 0", borderTop: "0.5pt solid var(--oraya-gold-28)", borderBottom: "0.5pt solid var(--oraya-gold-28)" }}>
              Seafood on the harbour, Lebanese and mezze in the Old Souk, breakfast on the seafront — our current tables live on the Living List, where they stay fresh. Scan the code below, or simply ask: Oraya can share the latest recommendations before your stay.
            </p>
          </div>
          <div>
            <p className="micro" style={{ color: "var(--oraya-terracotta)", margin: "0 0 2mm" }}>Practical & nearby</p>
            <Row label="Mini-market" labelWidth="30mm">Daily basics & ice · Mastita · 5 min</Row>
            <Row label="Bakery" labelWidth="30mm">Manakish from the morning oven · 5 min</Row>
            <Row label="Pharmacy" labelWidth="30mm">Jbeil · 8 min · non-urgent guidance: message Oraya</Row>
            <Row label="ATM & fuel" labelWidth="30mm" bottom>Banks & stations · Jbeil highway · 8 min</Row>
          </div>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: "5mm", borderTop: "0.5pt solid var(--oraya-gold-28)", paddingTop: "6mm" }}>
          <a href={EXPLORE_URL} className="warm-panel" style={{ display: "grid", gridTemplateColumns: "auto 1fr", columnGap: "6mm", alignItems: "center" }}>
            <img src={`${AB}/oraya-qr-living-list-byblos.svg`} alt="QR code — Oraya living list, Byblos" style={{ width: "19mm", height: "19mm", display: "block" }} />
            <div className="fact">
      ...
      <HbPage label="House Book — Living Spaces" tone="beige-light" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", columnGap: "4mm", marginBottom: "5mm" }}>
          <div className="arch-cell" style={{ paddingTop: "7mm" }}>
            ...
            <div className="tx">Readied before your stay. No diving; life rings poolside; children swim with an adult.</div>
          </div>
          <div className="arch-cell" style={{ paddingTop: "7mm" }}>
            ...
            <div className="tx">Kettle, microwave, gas cooktop and stove, cutlery and glassware.</div>
          </div>
          <div className="arch-cell" style={{ paddingTop: "7mm" }}>
        ...
        <div className="warm-panel" style={{ display: "flex", justifyContent: "space-between", gap: "8mm", marginBottom: "7mm", padding: "4mm 5.5mm" }}>
          <p className="body" style={{ fontSize: "9pt", fontWeight: 700, margin: 0 }}>Pool cover off before swimming — back on after every use.</p>
          <p className="body" style={{ fontSize: "9pt", margin: 0, color: "var(--oraya-muted)" }}>Garbage: a small bin per room, two large cans outdoors — never on the street.</p>
        </div>
        <div className="warm-panel" style={{ padding: "7mm 7mm 6mm" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 9mm" }}>
            <Row label="Wi-Fi">Network ORAYA · mesh coverage through the villa.</Row>
            <Row label="Hot water">Solar tank — heats by day, holds through the night. Call before any reset.</Row>
            <Row label="TV">Smart TV — Netflix, webOS, Cablevision.</Row>
            <Row label="Generator">Automatic backup; a brief start-up sound is normal.</Row>
            <Row label="Air conditioning">Every room; controller beside the light switch. Cools and heats.</Row>
            <Row label="Water supply">Municipal + rooftop tank; the pump activates on its own.</Row>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 18mm 1fr", columnGap: "5mm", height: "158mm" }}>
          <div style={{ display: "grid", alignContent: "space-evenly", gap: "6mm" }}>
            ...
            <div>
              ...
              <p className="body" style={{ margin: 0 }}>No diving. Children swim supervised; life rings are poolside. Pool cover off before swimming — back on after every use.</p>
            </div>
          </div>
      ...
      <HbPage label="House Book — Checkout" tone="beige-light" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        ...
        <div className="arch-panel" style={{ padding: "17mm 14mm 10mm" }}>
          ...
          <div style={{ maxWidth: "124mm", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5mm 10mm" }}>
            ...
            <Ck>AC & heating off</Ck>
            <Ck>Pool cover back on</Ck>
      ...
      <HbPage label="House Book — Emergency & Contacts" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto", columnGap: "8mm", alignItems: "center", padding: "5mm 0", borderTop: "0.5pt solid var(--oraya-gold-28)", borderBottom: "0.5pt solid var(--oraya-gold-28)", marginBottom: "6mm" }}>
          <div>
            <div className="fact">
              ...
              <div className="s">
                For medical emergencies, call the emergency service first. For non-urgent pharmacy guidance, message Oraya.{" · "}stayoraya.com
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", columnGap: "4mm" }}>
            ...
            <div className="warm-panel" style={{ padding: "3.5mm" }}><div className="body" style={{ fontSize: "8pt", lineHeight: 1.45 }}><strong>Pool cover</strong><br />Back on after every use</div></div>
