...
export default function PaymentPage() {
  return (
    <>
      ...
      <ul style={list}>
        <li>Secure online card payment powered by NetCommerce Secure Payment Gateway through Credit Libanais / CyberSource Unified Checkout, when enabled for your booking</li>
        <li>Whish</li>
        <li>Bank transfer</li>
        <li>Cash</li>
      </ul>
