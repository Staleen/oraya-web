  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: "520px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap", marginTop: "0" }}>
          <a
            href={`https://wa.me/0000000000?text=${encodeURIComponent(`Hello Oraya! I just made a reservation. My reference number is ${id ? id.slice(0, 8).toUpperCase() : "N/A"}.`)}`}
            target="_blank"
