...
- Work on a new branch off latest `master` (if the environment forces a `claude/...` branch name, use it and note it here). Never push to master; land via PR.
...
- [ ] A.2 **"Forgot password" recovery via admin email**:
