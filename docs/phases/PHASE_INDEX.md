...
## Phase 16 — Consolidated roadmap (16A and 16C complete; 16B active closeout)

- **Status:** 🟡 in progress at the Phase 16 umbrella level because 16B remains in active closeout and 16D–16J are planned.
- **Sub-phases:**
  - **16A — WhatsApp AI Butler & Guest Identification:** ✅ complete for the approved production scope. Native WhatsApp stay intake, secure website handoff, and identity-safe booking support are shipped. Later WhatsApp enhancements require fresh scoped tasks and do not reopen 16A automatically.
  - **16B — Complete Payment System:** 🟡 active closeout. The canonical payment-request and immutable-ledger foundation, manual rails, standalone links, card bridge, and payment operations surfaces are shipped; provider configuration, controlled evidence, reconciliation/settlement, and independently gated methods remain. NetCommerce/CyberSource is one workstream, not the phase boundary. See [/docs/system/PHASE_16B_PAYMENT_SYSTEM_MISSION.md](../system/PHASE_16B_PAYMENT_SYSTEM_MISSION.md).
  - **16C — Guest Experience & Arrival Guide:** ✅ complete for the approved scope. House Books, Explore guides, the private personalized Arrival Guide, and approved email/manual/WhatChimp delivery paths are shipped. Smart access remains excluded.
  - **16D — Smart Access & Arrival Automation:** ⏳ planned. Secure access credentials and arrival automation; the 8-character booking reference remains a public support code, never an access PIN.
  - **16E — Guest Operations & Automated Hospitality:** ⏳ planned. Restores the operational-messaging layer across pre-arrival, arrival, stay, and checkout hospitality.
  - **16F — Membership, Loyalty & CRM:** ⏳ planned. The former 16E membership workstream moves here; existing member accounts do not complete the broader loyalty/CRM scope.
  - **16G — SEO & Organic Growth:** ⏳ planned. Extends the already-shipped technical SEO/indexing foundations into broader organic growth.
  - **16H — Multilingual & International Guest Experience:** ⏳ planned. Coherent Arabic, French, and English guest experience.
  - **16I — Reputation, Reviews & Guest Retention:** ⏳ planned. Review, feedback, reputation, and repeat-stay lifecycle.
  - **16J — Revenue & Business Intelligence:** ⏳ planned. Broader commercial and profitability intelligence; already-shipped `/ops` metrics remain current truth rather than future work.
- **Cross-phase closeout:** the `/admin` → `/ops` migration is not a numbered Phase 16 workstream. See [/docs/system/OPS_MIGRATION_PLAN.md](../system/OPS_MIGRATION_PLAN.md).
- **Authoritative refs:** [/PHASE_16_PLAN.md](../../PHASE_16_PLAN.md) (canonical general roadmap), [/docs/system/PROJECT_STATE.md](../system/PROJECT_STATE.md) (current technical truth), [/docs/system/CURRENT_PHASE.md](../system/CURRENT_PHASE.md) (active closeout snapshot), and [/docs/system/DECISIONS_LOG.md](../system/DECISIONS_LOG.md) (2026-08-09 supersession decision). Planned implementation remains gated on an approved architecture/audit pass per [/docs/system/AGENT_RULES.md](../system/AGENT_RULES.md) §3 and `PROJECT_STATE.md` constraint #9.
