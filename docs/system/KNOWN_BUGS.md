...
- **Recommended fix path:** run the round trip #4 procedure in [V6_ROUNDTRIP_CHECKLIST.md](../../artifacts/whatchimp/V6_ROUNDTRIP_CHECKLIST.md) (fresh disposable bot, draw exactly the 39 checklist connections, TEST integrations only), then live checklist section C.
