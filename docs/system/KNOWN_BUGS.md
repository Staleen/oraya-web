...
- **Recommended fix path:** run the round trip #2 procedure in [artifacts/whatchimp/V6_ROUNDTRIP_CHECKLIST.md](../../artifacts/whatchimp/V6_ROUNDTRIP_CHECKLIST.md) (fresh disposable bot, TEST integrations only), then live checklist section C.
